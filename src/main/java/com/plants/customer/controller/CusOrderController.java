...
/*	 @PostMapping("/CreateOrder")
	     ...
	     if (!activeAgents.isEmpty()) {
	         for (AgentMain agent : activeAgents) {
	             if (agent.isActiveAgent()) {
	                 ...
	                 boolean isWithinRange = this.locationService.isWithinRange(
	                     customerDetails.getLatitude(), customerDetails.getLoggitude(),
	                     agent.getLatitude(), agent.getLongitude()
	                 );
	                 ...
	                 if (isWithinRange) {
	                     ...
	                     sendNotificationToAgent(agent, "You have a new order nearby", "Please check the app for details.");
	                 }
	             }
	         }
	     }
	 ...
	 private void sendNotificationToAgent(AgentMain agent, String title, String message) {
		    try {
		        ...
		        Message firebaseMessage = Message.builder()
		            ...
		            .setNotification(Notification.builder()
		                ...
		                .setBody(message)
		                .build())
		            .putData("agentId", String.valueOf(agent.getAgentIDPk())) // Add any additional data if needed
		            .build();
